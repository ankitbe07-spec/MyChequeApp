...
<div id="cheque_box" style="border: 2px dashed #bbb; width: {preview_w}px; height: {preview_h}px; position: relative; {bg_style} margin: auto; overflow: hidden; font-family: '{new_f_fam}', sans-serif;">
